...
// ==================================================================================
// 🎨 SUB-COMPONENTE: REPORTE DE AUDITORÍA V2
// ==================================================================================
...
export const ExpertProfile = () => {
  ...
  const handleVoiceTest = async () => {
    ...
    try {
      ...
      setChatHistory(prev => [...prev, { question: chatInput, answer: `Error: ${e.message}` }]);
    }
    finally { setIsProcessing(false); }
  };
              ...
              <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-300">
                ...
                <div>
                  ...
                  <textarea 
                    ...
                    placeholder="Tu crisis → Tu descubrimiento → Tu transformación."
                  />
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
              ...
              <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-300">
                ...
                <div>
                  ...
                  <textarea 
                    ...
                    placeholder="¿En qué ideas QUIERES SER CONOCIDO? Ej: simplicidad, anti-mitos, procesos escalables..."
                  />
                  <p className="text-xs text-gray-500 mt-1 italic">
                    Define tu marca registrada conceptual. Ej: Alex Hormozi = "Value First"
                  </p>
                </div>
              ...
              <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-300">
                ...
                <div>
                  ...
                  <textarea 
                    ...
                    className="textarea-viral h-24" 
                    placeholder="Ej: Cliente X: De €0 a €50k/mes en 6 meses..."
                  />
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
              ...
              <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-300">
                ...
                <div>
                  ...
                  <textarea 
                    ...
                    className="textarea-viral h-32" 
                    placeholder="Describe tu metodología completa..."
                  />
                </div>
                <div>
              ...
              <div className="flex gap-2 bg-gray-900/50 p-1 rounded-lg">
                <button
                  ...
                  className={`flex-1 py-2 px-3 rounded text-[10px] font-black uppercase transition-all ${
                    aiMode === 'test' ? 'bg-green-600 text-white' : 'text-gray-500 hover:text-white'
                  }`}
                >
                ...
                <button
                  ...
                  className={`flex-1 py-2 px-3 rounded text-[10px] font-black uppercase transition-all ${
                    aiMode === 'xray' ? 'bg-indigo-600 text-white' : 'text-gray-500 hover:text-white'
                  }`}
                >
                ...
                <button
                  ...
                  className={`flex-1 py-2 px-3 rounded text-[10px] font-black uppercase transition-all ${
                    aiMode === 'amplify' ? 'bg-yellow-600 text-white' : 'text-gray-500 hover:text-white'
                  }`}
                >
